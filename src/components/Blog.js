  ...
  return (
    <>
      <div className="blog-container">
        ...
        <p>This page is part of the attempt to verify the run time complexities of various Binary Search Tree methods including:</p>
        <ul>
          <li>Insert</li>
          <li>Remove</li>
          <li>Contains</li>
  ...
  return (
    <>
      <div className="blog-container">
        <h2>Binary search tree slides</h2>
        <p>Below are some slides created while confirming the various run time complexity of various binary search tree methods. These slides were created in Keynote and exported as images. I wonder if there's any way to dynamically update this content?</p>
        <LazyLoad><img src={ require('../assets/slides/avl/avl.001.jpeg')}></img></LazyLoad>
        <LazyLoad><img src={ require('../assets/slides/avl/avl.002.jpeg')}></img></LazyLoad>
        <LazyLoad><img src={ require('../assets/slides/avl/avl.003.jpeg')}></img></LazyLoad>
        <LazyLoad><img src={ require('../assets/slides/avl/avl.004.jpeg')}></img></LazyLoad>
        <LazyLoad><img src={ require('../assets/slides/avl/avl.005.jpeg')}></img></LazyLoad>
        <LazyLoad><img src={ require('../assets/slides/avl/avl.006.jpeg')}></img></LazyLoad>
        <LazyLoad><img src={ require('../assets/slides/avl/avl.007.jpeg')}></img></LazyLoad>
        <LazyLoad><img src={ require('../assets/slides/avl/avl.008.jpeg')}></img></LazyLoad>
        <LazyLoad><img src={ require('../assets/slides/avl/avl.009.jpeg')}></img></LazyLoad>
        <LazyLoad><img src={ require('../assets/slides/avl/avl.010.jpeg')}></img></LazyLoad>
        <LazyLoad><img src={ require('../assets/slides/avl/avl.011.jpeg')}></img></LazyLoad>
        <LazyLoad><img src={ require('../assets/slides/avl/avl.012.jpeg')}></img></LazyLoad>
        <LazyLoad><img src={ require('../assets/slides/avl/avl.013.jpeg')}></img></LazyLoad>
      </div>
    </>
  );
}
